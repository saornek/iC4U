...
#define AIO_USERNAME         "Selinoid"  // Adafruit IO username (see http://accounts.adafruit.com/).
#define AIO_KEY              "my-io-key"  // Adafruit IO key (see settings page at: https://io.adafruit.com/settings).

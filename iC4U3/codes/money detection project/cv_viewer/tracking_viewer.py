...
df_labels = pd.read_csv("/home/ic4u/zed/codes/ic4u_MoneyQuantity/cv_viewer/moneydetection_labels.csv")
# ----------------------------------------------------------------------
#       2D LEFT VIEW
# ----------------------------------------------------------------------
    ...
    for obj in objects.object_list:
        if render_object(obj, is_tracking_on):
            ...
            if (isClassFound == True):
                ...
                text = str(objectCustomLabel) + " Dollar(s)"
            ...
            text_color = (0, 0, 0)
            cv2.putText(left_display, text, text_position, cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, text_color, 2)
